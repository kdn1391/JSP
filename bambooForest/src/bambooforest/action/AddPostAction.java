...
public class AddPostAction implements Action {
	...
	public String processGet(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {//list에서 글쓰기 버튼을 누를시 get방식으로 이쪽으로 이동한다. 
		// TODO Auto-generated method stub
		HttpSession session = request.getSession();//Servlet에서 HttpSession 객체 얻기 위하여 request.getSession() 함수를 이용한다
